...
def render_summary(result: dict) -> None:
    ...
    with col_left:
        ...
        st.markdown(
            ...
            <div style="background-color: #f0f2f6; border-radius: 5px; height: 10px; width: 100%;">
                <div style="background-color: {color}; border-radius: 5px; height: 10px; width: {reputation_score * 100}%;"></div>
            </div>
            """,
    ...
    if questions:
        ...
        st.write("Typical questions users might ask about your brand:")
