...
def test_extract_domains_from_sources():
    ...
    search_results = {
        "Question 1": [
            {"title": "Nike", "url": "https://nike.com", "snippet": "...", "domain": "nike.com"},
            {"title": "Adidas", "url": "https://adidas.com", "snippet": "...", "domain": "adidas.com"},
        ],
        "Question 2": [
            {"title": "Nike", "url": "https://nike.com", "snippet": "...", "domain": "nike.com"},
        ]
...
def test_format_llm_responses_for_analysis():
    ...
    search_results = {
        "What are the best Nike products?": [
            {"title": "Nike", "url": "https://nike.com", "snippet": "...", "domain": "nike.com"},
            {"title": "Reviews", "url": "https://reviews.com", "snippet": "...", "domain": "reviews.com"},
            {"title": "Amazon", "url": "https://amazon.com", "snippet": "...", "domain": "amazon.com"},
        ],
        "What are Nike's weaknesses?": [
            {"title": "Reddit", "url": "https://reddit.com", "snippet": "...", "domain": "reddit.com"},
        ]
    }
